\message{ !name(intersection_paper_v6.tex)}%\documentclass[journal]{IEEEtran}
...
\message{ !name(intersection_paper_v6.tex) !offset(-3) }
...
\message{ !name(intersection_paper_v6.tex) !offset(-519) }
