...
{
    'cm20PTMotorOutArray', {
	{'m0',		1,'cmPTMotorOut', -1, 'real', 'Sample'};
	{'m1',		1,'cmPTMotorOut', -1, 'real', 'Sample'};
    }
}
{
    'cm20PTMotorOutArray', {
...
}
{
	...
	{'m0',		1,'cmPTMotorOut', -1, 'real', 'Sample'};
	{'m1',		1,'cmPTMotorOut', -1, 'real', 'Sample'};
	{'m2',		1,'cmPTMotorOut', -1, 'real', 'Sample'};
	{'m3',		1,'cmPTMotorOut', -1, 'real', 'Sample'};
    }
}
{
    'cm20PTMotorOutArray', {
...
}
{
	...
	{'m2',		1,'cmPTMotorOut', -1, 'real', 'Sample'};
	{'m3',		1,'cmPTMotorOut', -1, 'real', 'Sample'};
	{'m4',		1,'cmPTMotorOut', -1, 'real', 'Sample'};
	{'m5',		1,'cmPTMotorOut', -1, 'real', 'Sample'};
	{'m6',		1,'cmPTMotorOut', -1, 'real', 'Sample'};
	{'m7',		1,'cmPTMotorOut', -1, 'real', 'Sample'};
    }
}
{
    'cm20PTMotorOutArray', {
