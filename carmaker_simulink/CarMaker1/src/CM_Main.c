...
#if defined(XENO) || defined(INTIME) || defined(ARTE_INTIME) || defined(LVRT) || defined(DSPACE)
...
#  if defined(XENO) || defined(INTIME) || defined(ARTE_INTIME) || defined(LVRT) || defined(_DSRT)
...
#  endif /* defined(XENO) || defined(INTIME) || defined(ARTE_INTIME) || defined(LVRT) || defined(_DSRT) */
#else
    /*** Non Real-Time	**********************************************/
...
#if defined(WITH_ADTF)
    ADTF_ApoMsg_Send(TimeGlobal, CycleNo);
#endif
